<div class="container py-5">
    <div class="row">
        ...
        <div class="col-md-8 mx-auto text-center">
            ...
            <p class="text-muted">Written By <strong><?php echo $data['penulis'] ?></strong></p>
            <p class="text-muted">Published By <?php echo $data['penerbit'] ?> | Year <?php echo $data['tahun_terbit'] ?><a href=""></a></p>
        </div>
