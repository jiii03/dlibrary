...
<div class="card">
    <div class="card-header">
        <h3 class="mt-3 text-center">Books</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Apakah anda yakin untuk menghapus kategori ini?')" href="?page=buku_hapus&&id=<?php echo $data['id_buku']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
