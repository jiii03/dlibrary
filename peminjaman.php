<div class="card">
    <div class="card-header">
        <h3 class="mt-3 text-center text-center">Book Loan</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <a href="?page=peminjaman_tambah" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Add Data</a>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if($data['status_peminjaman'] != 'Dikembalikan'){ ?>
                                ...
                                <a onclick="return confirm('Apakah anda yakin untuk menghapus kategori ini?')" href="?page=peminjaman_hapus&&id=<?php echo $data['id_peminjaman']; ?>" class="btn btn-danger">Delete</a>
                            <?php } ?>
                            </td>
                        </tr>
                    <?php
