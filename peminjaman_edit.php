<div class="card">
    <div class="card-header">
        <h2 class="mt4 text-center">Edit Book Loan</h2>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <select name="status_peminjaman" id="status_peminjaman" class="form-control">
                                <option <?php if($data['status_peminjaman'] == 'Dipinjam') echo 'selected'; ?> value="dipinjam">Borrowed</option>
                                <option <?php if($data['status_peminjaman'] == 'Dikembalikan') echo 'selected'; ?> value="dikembalikan">Returned</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="?page=peminjaman" class="btn btn-warning" name="back" value="back">Back</a>
                        </div>
                    </div>
                </form>
            </div>
